...
def main(args):
    ...
    for image_path in [input_path_a,input_path_b]:
...
def parse_arguments(argv):
    ...
    parser.add_argument('input_path_a', type=str, help='Directory with unaligned images.')
    parser.add_argument('output_path_b', type=str, help='Directory with aligned face thumbnails.')
